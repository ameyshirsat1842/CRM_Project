...
class AddRecordForm(forms.ModelForm):
    ...
    client_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder": "Client_name", "class": "form-control"}), label="")
    dept_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder": "dept_name", "class": "form-control"}), label="")
    phone = forms.CharField(required=True, max_length=10, widget=forms.widgets.TextInput(attrs={"placeholder": "phone", "class": "form-control"}), label="")
